...
class TestMyProfile:
    ...
    def test_switch_to_my_profile_tab(self, launch_app):
        my_profile_page = MyProfilePage(launch_app)
        my_profile_page.verify_text_in_my_profile_page()

    def test_add_video_in_collection(self, launch_app):
    ...
    def test_remove_video_in_collection(self, launch_app):
        my_profile_page = MyProfilePage(launch_app)
        my_profile_page.go_to_my_collection()
